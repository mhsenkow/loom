...
const DEFAULT_CIRCUITS: Record<string, SavedCircuit> = {
  ...
  'annoy-mode': {
    name: 'annoy-mode',
    description: 'Off by default. Set cron to * * * * * * to spam notifications every second.',
    savedAt: 1700000000000,
    cells: [
      {
        id: 'default-annoy-1',
      ...
      },
      {
        ...
        type: 'ai_processor',
        label: 'ANNOY MESSAGE',
        content: 'Write a short annoying alert in all caps. Keep it under 10 words and repetitive.',
        position: { x: 50, y: 200 },
        inputMode: 'none',
        modelSlot: 'C',
      },
      {
        ...
        position: { x: 50, y: 350 },
        inputMode: 'previous',
        notificationTitle: 'LOOM — ANNOY MODE',
        notificationBody: '{{input}}',
      },
    ],
    modelSlots: { A: '', B: '', C: '', IMAGE: '' },
  },
  'site-research-email-draft': {
    name: 'site-research-email-draft',
    description: 'OFF by default. Researches a website, drafts an email update, and saves it to outbox.',
    savedAt: 1700000000000,
    cells: [
      {
      ...
      },
      {
        ...
        type: 'shell_exec',
        label: 'FETCH SITE',
        content: 'curl -L -s https://example.com | head -n 120',
        shellExecCommand: 'curl -L -s https://example.com | head -n 120',
        position: { x: 50, y: 180 },
        inputMode: 'none',
      },
      {
        id: 'default-research-3',
        type: 'ai_processor',
        label: 'ANALYZE',
        content: 'Analyze this website content. Extract key updates, risks, and opportunities in concise bullets.',
        position: { x: 50, y: 310 },
        inputMode: 'previous',
        modelSlot: 'B',
      },
      {
        id: 'default-research-4',
        type: 'ai_processor',
        label: 'EMAIL DRAFT',
        content: 'Write an executive email update with: Subject line, 3 bullet takeaways, and one recommended action.',
        position: { x: 50, y: 440 },
        inputMode: 'previous',
        modelSlot: 'A',
      },
      {
        id: 'default-research-5',
        type: 'file_write',
        label: 'SAVE OUTBOX',
        content: 'outbox/site-research-email.txt',
        fileWritePath: 'outbox/site-research-email.txt',
        fileWriteMode: 'overwrite',
        position: { x: 50, y: 570 },
        inputMode: 'previous',
      },
      {
        id: 'default-research-6',
        type: 'notification',
        label: 'NOTIFY',
        content: '',
        notificationTitle: 'LOOM — Site Research Draft Ready',
        notificationBody: 'New site research email draft saved to outbox/site-research-email.txt',
        position: { x: 50, y: 700 },
        inputMode: 'none',
      },
    ],
  ...
  'status-watch-telegram': {
    name: 'status-watch-telegram',
    description: 'OFF by default. Checks a status page, summarizes impact, and sends to Telegram.',
    savedAt: 1700000000000,
    cells: [
      {
        id: 'default-status-1',
      ...
      },
      {
        id: 'default-status-2',
        type: 'shell_exec',
        label: 'FETCH STATUS PAGE',
        content: 'curl -L -s https://www.githubstatus.com/ | head -n 160',
        shellExecCommand: 'curl -L -s https://www.githubstatus.com/ | head -n 160',
        position: { x: 50, y: 180 },
        inputMode: 'none',
      },
      {
        ...
        content: 'Summarize the current service status. If incident keywords appear, start with ALERT:. Keep under 6 lines.',
        position: { x: 50, y: 310 },
        inputMode: 'previous',
        modelSlot: 'B',
      },
  ...
  'competitor-brief-notify': {
    name: 'competitor-brief-notify',
    description: 'OFF by default. Pulls a competitor page, creates a short brief, saves report, and notifies.',
    savedAt: 1700000000000,
    cells: [
      {
        id: 'default-brief-1',
      ...
      },
      {
        ...
        type: 'shell_exec',
        label: 'FETCH PAGE',
        content: 'curl -L -s https://openai.com/news/ | head -n 160',
        shellExecCommand: 'curl -L -s https://openai.com/news/ | head -n 160',
        position: { x: 50, y: 180 },
        inputMode: 'none',
      },
      {
        ...
        content: 'Create a competitor brief with: key announcements, strategic implications, and one response idea.',
        position: { x: 50, y: 310 },
        inputMode: 'previous',
        modelSlot: 'B',
      },
      {
        ...
        type: 'file_write',
        label: 'SAVE REPORT',
        content: 'reports/competitor-brief.txt',
        fileWritePath: 'reports/competitor-brief.txt',
        fileWriteMode: 'overwrite',
        position: { x: 50, y: 440 },
        inputMode: 'previous',
      },
      {
        ...
        label: 'NOTIFY',
        content: '',
        notificationTitle: 'LOOM — Competitor Brief Ready',
        notificationBody: 'Updated report saved to reports/competitor-brief.txt',
        position: { x: 50, y: 570 },
        inputMode: 'none',
      },
    ],
